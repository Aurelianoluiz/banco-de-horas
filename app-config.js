...
export const APP_CONFIG={storageKey:'banco_horas_v2',version:2,modules:['dashboard','calendario','apontamentos','banco','ajustes','ferias','folgas','atestados','colaboradores','relatorios','config']};
